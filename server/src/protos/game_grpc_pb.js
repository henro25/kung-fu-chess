...
function serialize_game_LobbyRequest(arg) {
  if (!(arg instanceof game_pb.LobbyRequest)) {
    throw new Error('Expected argument of type game.LobbyRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_game_LobbyRequest(buffer_arg) {
  return game_pb.LobbyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_game_LobbyResponse(arg) {
  if (!(arg instanceof game_pb.LobbyResponse)) {
    throw new Error('Expected argument of type game.LobbyResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_game_LobbyResponse(buffer_arg) {
  return game_pb.LobbyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
setLobbySettings: {
    path: '/game.GameService/SetLobbySettings',
    requestStream: false,
    responseStream: false,
    requestType: game_pb.LobbyRequest,
    responseType: game_pb.LobbyResponse,
    requestSerialize: serialize_game_LobbyRequest,
    requestDeserialize: deserialize_game_LobbyRequest,
    responseSerialize: serialize_game_LobbyResponse,
    responseDeserialize: deserialize_game_LobbyResponse,
  },
};
